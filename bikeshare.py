...
def get_filters():
    ...
    month = input('Please enter a month or all for not filtering by month:\njanuary\nfebruary\nmarch\napril\nmay\njune\nall\n').lower()   
    month_list = ['january','february','march','april','may','june','all']
    while month not in month_list:
        
        print('Ivalid input, Please enter a month or all for not filtering by month: january\nfebruary\nmarch\napril\may\njune\all\n')           
        month = input('Please enter a month or all for not filtering by month: january\nfebruary\nmarch\napril\nmay\njune\nall\n').lower()
    
    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = input('Please enter the day as (Sat, Sun, Mon, Tue, Wed, Thur, Fri) or all for all days\n').lower()
    day_list = ['sat','sun', 'mon', 'tue', 'wed', 'thur', 'fri','all']

    while day not in day_list:
        print('Invalid day, please enter the day as (Sat, Mon, Tue, Wed, Thur, Fri) or all for all days')
        day = input('Please enter the day as (Sat, Sun, Mon, Tue, Wed, Thur, Fri) or all for all days\n').lower()
...
def time_stats(df):
    ...
    print('Most common month is {} \n Most common day is {},\n Most Frequent Start Hour is {} :'.format(common_month,common_day,common_hour))
    print('-'*40)
...
def station_stats(df):
    ...
    print("\nThis took %s seconds." % (time.time() - start_time))
    print('common start station: {}\n common end station: {}\n common start/end station: {}\n'.format(common_start_station, common_end_station,common_start_end_station))
    print('-'*40)
...
def trip_duration_stats(df):
    ...
    print("\nThis took %s seconds." % (time.time() - start_time))
    print('total time of travel is: {}\nmean time of travel is: {}'.format(total_travel,mean_travel_time))
    print('-'*40)
